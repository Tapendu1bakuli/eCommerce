...
class Ui {
  ...
  static InputDecoration getInputDecoration(
    ...
    return InputDecoration(
        fillColor:CustomColor.deepBlue,
        filled: true,
      hintText: hintText,
      hintStyle: TextStyle(
        letterSpacing: 0,
      ...
      contentPadding: EdgeInsets.symmetric(vertical: 20),
        border: OutlineInputBorder(
            ...
            borderSide: BorderSide(
              color: CustomColor.deepBlue.withOpacity(0.6),
              width: 2,
            )),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: CustomColor.deepBlue.withOpacity(0.4), width: 2),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: CustomColor.deepBlue.withOpacity(0.1), width: 2),
        ),
