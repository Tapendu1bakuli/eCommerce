      ...
      case Type.searchField:
        {
          return TextFormField(
            ...
            style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                ...
                fontFamily: 'NunitoSans'),
            decoration: InputDecoration(
              fillColor: CustomColor.primaryWhite,
              filled: true,
              floatingLabelBehavior: FloatingLabelBehavior.always,
              labelText: widget.labelText,
              hintText: widget.hintText ?? '',
              ...
              prefixIcon: Padding(
                ...
                child: Image.asset(ImageUtils.searchPrefix),
              ),
              suffixIcon: Padding(
                padding: EdgeInsets.symmetric(horizontal: ScreenConstant.defaultHeightTen),
                child: Image.asset(ImageUtils.searchSuffix,height: ScreenConstant.defaultHeightTen,),
              ),
              labelStyle: Theme.of(context).textTheme.bodySmall!.copyWith(
                  color: Get.theme.colorScheme.onSurface,
                  fontFamily: 'NunitoSans'),
              ...
              focusedBorder: OutlineInputBorder(
                ...
                borderSide: const BorderSide(
                    color: CustomColor.shadesOfBlack, width: 2
        ),
              ),
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(10),
